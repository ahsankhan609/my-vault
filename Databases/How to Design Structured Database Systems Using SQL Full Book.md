...
![Show an example of a Star schema, with a central fact table connected to several dimension tables around it. From https://en.wikipedia.org/wiki/Star_schema](https://upload.wikimedia.org/wikipedia/commons/b/bb/Star-schema.png)
...
![An example of a Snowflake schema, with a central fact table connected to several dimension tables subdivided into more dimensions around it. https://en.wikipedia.org/wiki/Snowflake_schema](https://upload.wikimedia.org/wikipedia/commons/b/b2/Snowflake-schema.png)
...
![Entity City represented in an entity-relationship diagram. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751733945183/6d737d7b-f6f3-42af-ae91-3fae793524a0.png)
...
![Entity-relationship diagram showing entities City and Person, where each city can have one or more people living in it. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751783067882/835a4c1c-1913-4847-9649-f2082d19d410.png)
...
![Entity-relationship diagram showing City and Person, where each city has one or more residents. Image by author.](https://cdn.hashnode.com/res/hashnode/image/upload/v1751789958682/1f5aa10e-3120-49a1-a7f0-9791a3f2e25e.png)
...
![Entity-relationship diagram showing City and Person entities. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751792178992/276f82ef-6895-487c-b7a0-7f1d01d9525f.png)
...
![Entity-relationship diagram where Person has a friendship relationship with itself. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751795267979/91b3c5e3-5642-40eb-a270-721ceb8cd93a.png)
...
![Entity-relationship diagram showing City and Person entities. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751797687686/758c9f22-ceb2-4c01-a0be-34219c1ee592.png)
...
![Entity-relationship diagram where City and Person are linked through Residence. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751797354936/4c721372-a21c-4aa3-8ddb-29d81ecbc830.png)
...
![Entity-relationship diagram where City is made up of instances of Person and each person consists of a single Brain. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751810875604/7b9044be-8d9b-43f2-8d80-61a190c23b6b.png)
...
![Entity-relationship diagram with inheritance where Client and Employee are subclasses of Person. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751812519420/7e7fe801-22df-4411-862d-e74a1b56e263.png)
...
![Venn diagram where Client and Employee are subsets of Person, with possible overlap. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751814124946/fa1daef2-46b0-47a8-8f62-c32642d5a165.png)
...
![Fan trap example. Image by author.](https://cdn.hashnode.com/res/hashnode/image/upload/v1751814711606/798ec2c1-20dc-47d0-905b-acdc8becc39f.png)
...
![Chasm trap example. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751818303502/70eecb3e-f2f1-4989-9348-afb81fb71346.png)
...
![Entity-relationship diagram with the entity Person. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751882614007/17c082cf-4d82-48ec-8595-bae0e7497236.png)
...
![Entity-relationship diagram where a City is associated with many Person. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751879685769/0d55f4c4-ce27-4aaf-8fc4-59a9717cdb77.png)
...
![Entity-relationship diagram where each Pool belongs to one person, and a person can have multiple pools. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751883961923/4b86fca3-7a3a-43fe-9fc8-f24a98d405cf.png)
...
![Entity-relationship diagram where each person is composed of one brain. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751893494662/a3f06614-4314-48f5-8a0d-091515af9e1d.png)
...
![Entity-relationship diagram where Residence is a weak entity that connects City and Person with start and end dates. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751898026686/2cdc320d-f665-4977-95de-d606a86a9ab2.png)
...
![Entity-relationship diagram where Residence connects City and Person with residency dates. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751895191612/68997989-56ee-4a31-bd47-18bb12d9cb60.png)
...
![Entity-relationship diagram where Residence connects cities and people, allowing multiple relationships on both sides. Image by author.](https://cdn.hashnode.com/res/hashnode/image/upload/v1751911354847/f2fb30d9-dcd6-4c0e-8931-40d8ae2f8a76.png)
...
![Entity-relationship diagram where Residence connects City and Person, with an additional direct relationship between them. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751904973527/7d253452-3cdd-4d17-bbfe-cdce7e064f89.png)
...
![Entity-relationship diagram where Person has a follow relationship with itself. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1751796543335/1224219f-98b8-459b-ae74-e704d06e797a.png)
...
![Entity-relationship diagram where Pool is a weak entity dependent on City. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752060524956/e7efb90c-04f2-4581-b12d-cb443a028f25.png)
...
![Entity-relationship diagram where a City can have none or one Pool, and a pool can belong to none or one city. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752061005445/a3dab918-7ccc-42b8-b0da-2956bebe1e79.png)
...
![Relational schema diagram where Pool references City through a foreign key. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752067358857/9f4bba9e-330a-44d3-b162-32681c5e5196.png)
...
![Relational schema diagram where Person and Brain reference each other through foreign keys. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752069584062/a369d85c-5287-48e8-8822-18f503c0ae9e.png)
...
![Entity-relationship diagram where each House belongs to a single Person, who can have multiple houses. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752069775099/caf1b28f-a301-451a-942f-a6a381f10ca5.png)
...
![Relational schema diagram where House references Person through a foreign key. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752074660667/ba64c7d8-7315-4f00-b3ff-0915af14d5d4.png)
...
![Entity-relationship diagram where House and Person have a many-to-many relationship. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752077406305/f54614f5-082a-4541-bc82-7146ffc640db.png)
...
![Entity-relationship diagram where Property connects houses and people with sale dates and prices. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752070941510/823b8d0c-c00f-4115-92bb-59b31f8fc1a1.png)
...
![Relational schema diagram where Property references House and Person through foreign keys. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752071179227/4dd3de56-2a14-4cbc-ab56-944445b7de91.png)
...
![Entity-relationship diagram where Property is a weak entity that connects House and Person with sales data. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752070430749/a6f7f0cc-7fcb-4fce-ac0f-6d41fc1e7610.png)
...
![Entity-relationship diagram where Property links houses and people with purchase and sale information. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752070636272/b40fe320-933b-46c3-98b0-7d0838c59de1.png)
...
![Relational schema diagram where Property references House and Person through foreign keys. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752071302075/d712f40f-1b86-4a5c-bc84-0f5f33851215.png)
...
![Entity-relationship diagram with inheritance where CityPool and OlympicPool are subclasses of Pool. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752081799527/5f6d4146-0884-4ba5-8125-3ae064748ff6.png)
...
![Relational schema where CityPool and OlympicPool inherit common attributes and add specific fields. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752084244540/f47a6034-0fa1-43e4-8040-ad5177e1976d.png)
...
![Relational schema where OlympicPool inherits from Pool, adding competition and certification attributes. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752084458598/f27a5174-8f88-4ed1-8459-1dd1cb15c8dc.png)
...
![Relational schema where CityPool and OlympicPool inherit from Pool, adding specific attributes. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752084637220/69491535-2a0c-4080-bf09-10967addced1.png)
...
![Entity-relationship diagram where Rental is a weak entity that connects Person and Bike with rental data. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752248008262/339c85d9-14a2-4d63-9453-c0f1a36e90f0.png)
...
![Relational schema diagram where Rental references Bike and Person through foreign keys. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752248300505/daa2d932-d838-4ba4-8f4b-1abaa5f31f98.png)
...
![Entity-relationship diagram that we will work with in this chapter. It represents various entities and relationships, where entities include "Vehicle," "Person," "Car," "Pool," "City," and others. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1754234568579/a4165e66-85f1-4a81-b85d-a2be8ea19db3.jpeg)
...
![Relational diagram derived from the previous entity-relationship one. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1753355497082/c7f6079b-a88b-4651-a92b-36761151aa80.png)
...
![Part of the entity-relationship diagram where the IS-A hierarchy of vehicles is represented according to their type. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1754729845339/090a3c2f-0833-4f14-8a58-52fb1a1606ea.png)
...
![Entity-relationship diagram with inheritance where Bike and Car are subclasses of Vehicle. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752833986569/a77fb4b1-3632-4d63-ad28-750c6768ef0d.png)
...
![Entity-relationship diagram with incomplete and disjoint inheritance where AcceptedRequest is a subclass of Request. Image by author. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1752916101394/f9b94685-4891-4174-b38d-35c6d164744b.png)
...
![Part of the entity-relationship diagram where the IS-A hierarchy of pools is represented according to their type. Image by author.](https://cdn.hashnode.com/res/hashnode/image/upload/v1754731726248/2494ed94-aca0-401d-abe5-1e91481f336a.png)

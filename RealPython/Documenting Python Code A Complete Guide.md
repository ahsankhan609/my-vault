...
tags:
  ...
  - best-practices
---
![Documenting Python Code Guide](https://realpython.com/cdn-cgi/image/width=1920,format=auto/https://files.realpython.com/media/Documenting-Python-Code_Watermarked.0b26408a1b7f.jpg)
...
[Documenting Python Code: A Complete Guide](https://realpython.com/quizzes/documenting-python-code/)
...
Commenting your code serves [multiple purposes, including](https://en.wikipedia.org/wiki/Comment_\(computer_programming\)#Uses):
...
Comments to your code should be kept brief and focused. Avoid using long comments when possible. Additionally, you should use the following four essential rules as [suggested by Jeff Atwood](https://blog.codinghorror.com/when-good-comments-go-bad/):
...
From examining the type hinting, you can immediately tell that the function expects the input `name` to be of a type `str`, or [string](https://realpython.com/python-strings/). You can also tell that the expected output of the function will be of a type `str`, or string, as well. While type hinting helps reduce comments, take into consideration that doing so may also make extra work when you are creating or updating your project documentation.

You can learn more about type hinting and type checking from [this video created by Dan Bader](https://www.youtube.com/watch?v=2xWhaALHTvU).
...
2. **[Docstring Types](#docstring-types):** The various docstring “types” (function, class, class method, [module, package](https://realpython.com/python-modules-packages/), and script)
...
> [!primary] Primary
> **Note:** To learn more about docstrings and how to create them, check out [How to Write Docstrings in Python](https://realpython.com/how-to-write-docstrings-in-python/).

## Documenting Your Python Projects

Python projects come in all sorts of shapes, sizes, and purposes. The way you document your project should suit your specific situation. Keep in mind who the users of your project are going to be and adapt to their needs. Depending on the project type, certain aspects of documentation are recommended. The general [layout](https://realpython.com/python-application-layouts/) of the project and its documentation should be as follows:
...
- **Code of Conduct:** Defines how other contributors should treat each other when developing or using your software. This also states what will happen if this code is broken. If you’re using Github, a Code of Conduct [template](https://help.github.com/articles/adding-a-code-of-conduct-to-your-project/) can be generated with recommended wording. For Open Source projects especially, consider adding this.
...
Daniele Procida gave a wonderful [PyCon 2017 talk](https://www.youtube.com/watch?v=azf6yzuJt54) and subsequent [blog post](https://www.divio.com/en/blog/documentation/) about documenting Python projects. He mentions that all projects should have the following four major sections to help you focus your work:
...
| [MkDocs](https://www.mkdocs.org/) | A static site generator to help build project documentation using the Markdown language. Check out [Build Your Python Project Documentation With MkDocs](https://realpython.com/python-project-documentation-with-mkdocs/) to learn more. |
...
1. [Carol Willing - Practical Sphinx - PyCon 2018](https://www.youtube.com/watch?v=0ROZRNZkPS8)
2. [Daniele Procida - Documentation-driven development - Lessons from the Django Project - PyCon 2016](https://www.youtube.com/watch?v=bQSR1UpUdFQ)
3. [Eric Holscher - Documenting your project with Sphinx & Read the Docs - PyCon 2016](https://www.youtube.com/watch?v=hM4I58TA72g)
...
[» More about James](https://realpython.com/team/jmertz/)

---

Keep Learning

Related Topics: [intermediate](https://realpython.com/tutorials/intermediate/) [best-practices](https://realpython.com/tutorials/best-practices/)

Related Learning Paths:

- [Write More Pythonic Code](https://realpython.com/learning-paths/writing-pythonic-code/?utm_source=realpython&utm_medium=web&utm_campaign=related-learning-path&utm_content=documenting-python-code)

Related Courses:

- [Documenting Code in Python](https://realpython.com/courses/documenting-python-code/?utm_source=realpython&utm_medium=web&utm_campaign=related-course&utm_content=documenting-python-code)

Related Tutorials:

- [How to Write Docstrings in Python](https://realpython.com/how-to-write-docstrings-in-python/?utm_source=realpython&utm_medium=web&utm_campaign=related-post&utm_content=documenting-python-code)
- [How to Write Beautiful Python Code With PEP 8](https://realpython.com/python-pep8/?utm_source=realpython&utm_medium=web&utm_campaign=related-post&utm_content=documenting-python-code)
- [pytest Tutorial: Effective Python Testing](https://realpython.com/pytest-python-testing/?utm_source=realpython&utm_medium=web&utm_campaign=related-post&utm_content=documenting-python-code)
- [Primer on Python Decorators](https://realpython.com/primer-on-python-decorators/?utm_source=realpython&utm_medium=web&utm_campaign=related-post&utm_content=documenting-python-code)
- [Python Type Checking (Guide)](https://realpython.com/python-type-checking/?utm_source=realpython&utm_medium=web&utm_campaign=related-post&utm_content=documenting-python-code)